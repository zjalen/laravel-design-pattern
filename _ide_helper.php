 ...
 */
     ...
     */ 
         ...
         * @static 
         */ 
        public static function success($data = null, $code = 1, $statusCode = 200)
        {
                        return \Illuminate\Routing\ResponseFactory::success($data, $code, $statusCode);
        }
                    /**
         * 
         *
         ...
         * @static 
         */ 
        public static function fail($errorMessage = null, $code = 400, $statusCode = 400)
        {
                        return \Illuminate\Routing\ResponseFactory::fail($errorMessage, $code, $statusCode);
        }
